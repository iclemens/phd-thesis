...
Most participants are able to do this perfectly, regardless of the reference angle (see Figure XB). Their uncertainty does increase as a function of reference angle though (see Figure XC).
