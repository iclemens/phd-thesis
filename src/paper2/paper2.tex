...
\begin{figure}
    ...
    \caption{Performance in one subject (S1). The proportion of rightward responses is plotted against probe location relative to the reference. Size of a data point represents the number of trials tested. Solid lines, best-fit cumulative Gaussians, characterized by bias (l) and standard deviation (r). \panelref{A} Constant reference depth, variable fixation depth, 150 \si{\milli\metre} translation. \panelref{B} Constant reference depth, variable fixation depth, 300 \si{\milli\metre} translation. \panelref{C} Variable reference depth, constant fixation depth, 150 \si{\milli\metre} translation. \panelref{D} Variable reference depth, constant fixation depth, 300 \si{\milli\metre}  translation.}
...
\begin{figure}
    ...
    \caption{Top view of the updating biases ($\mu$). Dots, individual bias values; error bars, averages (\textpm SD) across participants; +, fixation point. \panelref{A} to \panelref{D}: Conditions as in Figure \ref{p2:fig2}.}
